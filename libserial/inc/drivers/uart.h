...
#define UART1_STOP_TX()                      __uart_start(&uart1_cfg)
#define UART1_STOP_RX()                      __uart_start(&uart1_cfg)
#define UART1_SEND(msg)                      __uart_send (&uart1_txQ, msg)
// NOTE the msg in the read macro is a char array and is passed by referance.
#define UART1_READ(msg)                      __uart_read (&uart1_rxQ, messages_received_uart1, &uartmsg)
